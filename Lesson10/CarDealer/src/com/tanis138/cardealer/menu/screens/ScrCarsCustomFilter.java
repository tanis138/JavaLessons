...
public class ScrCarsCustomFilter extends MenuScreenWork {
    ...
    public int display() {
        ...
        System.out.println("Example:  y1=2015;p2=20000;g=a;f=p;t=n;m=A3;s=p");
        System.out.println("Result:   New Audi A3 (AT, petrol) with price <= $20000 and year >= 2015 sort by price");
        System.out.println();
